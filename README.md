...
1. Install package:
```sh
composer require kiwina/laravel-zeromq "^1.0"
```
...
'providers' => [
    ...
    Kiwina\ZeroMQ\Providers\ServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'ZeroMQ' => Kiwina\ZeroMQ\Facades\ZeroMQ::class,
];
```

3. Publish config file
`php artisan vendor:publish --provider="Kiwina\ZeroMQ\Providers\ServiceProvider"` in your project directory.
...
## Facade
```php
use Kiwina\ZeroMQ\Facades\ZeroMQ;
